...
class Config:
    ...
    def __init__(self):
        ...
        # In production, environment variables are set directly by the hosting platform
        ...
        # Cloud platforms use PORT environment variable, fallback to BACKEND_PORT for local dev
