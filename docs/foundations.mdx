...
graph LR
    subgraph "Forward Kinematics"
        JA[Joint Angles<br/>θ₁, θ₂, ..., θₙ] --> FK[Forward<br/>Kinematics] --> EE[End-Effector<br/>Position & Orientation]
    end

    subgraph "Inverse Kinematics"
        EE2[Desired End-Effector<br/>Position & Orientation] --> IK[Inverse<br/>Kinematics] --> JA2[Joint Angles<br/>θ₁, θ₂, ..., θₙ]
    end
...
**Homogeneous transformation matrices** (4×4) represent position and orientation changes between frames:
